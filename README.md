...
| 🚀 **Space Management**                                                                                                                                                                                                                                              | 🌳 **Workspace Organization**                                                                                                                                                                                                                                         |
| • Create new spaces with custom features<br>• Update space settings and privacy<br>• Configure due dates, time tracking, tags<br>• Enable/disable space features<br>• Natural language color support<br>• Delete spaces (with caution)                               | • Navigate spaces, folders, and lists<br>• Create and manage folders<br>• Organize lists within spaces<br>• Create lists in folders<br>• View workspace hierarchy<br>• Efficient path navigation                                             |
| ⏱️ **Time Tracking**                                                                                                                                                                                                                                          |                                                                                                                                                                                                                                                                            |
| • View time entries for tasks<br>• Start/stop time tracking on tasks<br>• Add manual time entries<br>• Delete time entries<br>• View currently running timer<br>• Track billable and non-billable time                                 |                                                                                                                                                                                                                                                                            |
...
| 👁️ **View Management**                                                                                                                                                                                                                                          |                                                                                                                                                                                                                                                                            |
| • Create views at any hierarchy level<br>• Support for all view types (list, board, calendar, etc.)<br>• Configure grouping, filtering, and sorting<br>• Update view settings and layouts<br>• Retrieve tasks with view filters applied<br>• Delete views when no longer needed |                                                                                                                                                                                                                                                                            |
...
| [create_view](docs/view-management.md)                                | Create a new view               | `name`, `type`, `parentType`                                                                                          |
| [get_views](docs/view-management.md)                                  | Get all views in a container    | `parentType`                                                                                                                 |
| [get_view](docs/view-management.md)                                   | Get view details                | `viewId`/`viewName`                                                                                                      |
| [update_view](docs/view-management.md)                                | Update view configuration       | `viewId`/`viewName`                                                                                                      |
| [delete_view](docs/view-management.md)                                | Delete a view                   | `viewId`/`viewName`                                                                                                      |
| [get_view_tasks](docs/view-management.md)                             | Get tasks from a view           | `viewId`/`viewName`                                                                                                      |
| [create_space](docs/space-management.md)                              | Create a new space              | `name`                                                                                                                       |
| [get_space](docs/space-management.md)                                 | Get space details               | `spaceId`/`spaceName`                                                                                                    |
| [update_space](docs/space-management.md)                              | Update space settings           | `spaceId`/`spaceName`                                                                                                    |
| [delete_space](docs/space-management.md)                              | Delete a space                  | `spaceId`/`spaceName`                                                                                                    |
